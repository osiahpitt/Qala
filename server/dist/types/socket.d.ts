...
export interface SocketEvents {
    ...
    'matching:accept_match': (data: {
        matchId: string;
        sessionId: string;
    }, callback: (response: MatchActionResponse) => void) => void;
    'matching:reject_match': (data: {
        matchId: string;
    }, callback: (response: MatchActionResponse) => void) => void;
    'matching:match_accepted': (data: {
        matchId: string;
        sessionId: string;
        acceptedBy: string;
    }) => void;
    ...
    'webrtc:connection_ready': (data: {
        sessionId: string;
        from?: string;
    }) => void;
    'heartbeat': (callback: (data: {
        timestamp: number;
    }) => void) => void;

  ...
  return (
    <div className="netflix-hero">
            ...
            onError={() => {
              ...
              if (element) {
                element.style.background =
                  'linear-gradient(135deg, #2c1810 0%, #1a0f0a 50%, #0f0806 100%)'
      ...
      <div className="netflix-content shifted">
        ...
        <h1 className="netflix-main-header">{headline}</h1>

        {/* Pricing Information */}
        <p className="netflix-subscription-info">{pricing}</p>

        {/* Subheadline */}
        <h2 className="netflix-subheader">{subheadline}</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="netflix-email-form">
            <input
              ...
              className={`netflix-transparent-input ${error ? 'border-red-500' : ''}`}
            ...
            <QalaButton
              ...
              variant="gold"
              size="lg"
              className="netflix-get-started-btn whitespace-nowrap"
          ...
          {/* Error Message */}
          {error && (
            <div id="email-error" className="mt-3 text-red-400 text-sm text-center" role="alert">
              {error}
            </div>
          )}
        </form>
